...
final class MegaSenaStatistics: Codable {
    var id: Int?
    var one: Int
    var two: Int
    var three: Int
...
extension MegaSenaStatistics: PostgreSQLModel {}
extension MegaSenaStatistics: Migration {}
extension MegaSenaStatistics: Content {}
extension MegaSenaStatistics: Parameter {}