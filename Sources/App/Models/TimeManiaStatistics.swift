...
final class TimeManiaStatistics: Codable {
    var id: Int?
    var one: Int
    var two: Int
    var three: Int
...
extension TimeManiaStatistics: PostgreSQLModel {}
extension TimeManiaStatistics: Migration {}
extension TimeManiaStatistics: Content {}
extension TimeManiaStatistics: Parameter {}
